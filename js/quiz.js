  ...
  .controller('QuizController', function() {
    ...
    var questions = {
      'image': [
        ...
        {file:'pulpfiction.png', options: [ 'The Usual Suspects', 'True Romance', 'Pulp Fiction', 'Get Shorty' ], correct: 2, answer: null},
        ...
        {file:'x-men.png', options: [ 'X-Men: Days Of Future Past', 'Fantastic Four', 'Terminator: Genisys', 'Pirates of the Caribbean: Dead Men Tell No Tales' ], correct: 0, answer: null},
